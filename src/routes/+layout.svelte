<script lang="ts">
	...
	import CheckerBoard from 'phosphor-svelte/lib/Checkerboard';
	import Throphy from 'phosphor-svelte/lib/Trophy';
...
<title>Pirat Whist</title>
<div class="navbar bg-base-100 shadow-sm">
	<div class="container mx-auto flex items-center">
		<div class="navbar-start">
			<div class="dropdown">
				<div tabindex="0" role="button" class="btn btn-ghost text-primary lg:hidden">
